...
public class Library_management extends JFrame implements ActionListener {
    ...
    public Library_management() {
        ...
        // Initialize the panel and add components to it
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == addButton) {
            ...
            // Create a JTable to display the books
            ...
            // Prompt the user to enter the book ID to edit
            ...
            // Prompt the user to enter the book ID to delete
